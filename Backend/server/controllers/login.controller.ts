...
//                     `phone number is not valid, must be more than 5 and less than 10 digits`
//                 );
//
//             // check for phone number is registered or not
//             const isPhoneRegistered = await Schema.User.findOne ({
//                 where :{phoneNumber} ,
//             });
...
//
//             // generate OTP
//             const {otp , otpToken} = generateOtpAndTokenHash (phoneNumber);
//
...
//                 phoneNumber ,
//                 message :
//                     "otp has been sent to your phone number! Otp valid for 2 minutes" ,
//             });
//         } catch (e) {
//             next (e);
//         }
...
// router.post (
//     "/with-otp/:phoneNumber/verify" ,
//     requiredLoginOtpVerification ,
//     async (req: RequestInterface , res: ResponseInterface , next: Next) => {
//         try {
